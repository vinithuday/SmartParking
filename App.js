    ...
    if (jwt) {
      ...
      try {
        ...
        if (response.status === 201) {
          ...
          console.log(response.data.hasOwnProperty("email"));
      ...
      >
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen
            name="LoginScreen"
          >
          {() => isLoggedIn?<Map email={userEmail}/>:<LoginScreen isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} setUserEmail={setUserEmail}/>}
          </Stack.Screen>
